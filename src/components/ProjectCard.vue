...
const myCarousel = useTemplateRef("project_carousel");
      ...
      <BCard @mouseenter="resume" @mouseleave="pause">
        ...
        >
          <BCarouselSlide
            ...
            :key="index"
            :img-src="image"
            :img-alt="`Image ${index + 1} for project: ${project}`"
          />
        </BCarousel>
        <div
          v-if="title"
          class="position-absolute bottom-0 w-100 bg-light text-center custom-card-title"
        >
